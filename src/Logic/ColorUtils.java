...
public class ColorUtils {
    ...
    private ArrayList<ColorName> initColorList() {
        ...
        colorList.add(new ColorName("Green", 117, 164, 91));
        colorList.add(new ColorName("Green1", 77, 134, 61));
        colorList.add(new ColorName("Green2", 24, 42, 17));
        colorList.add(new ColorName("Green3", 91, 142, 60));
        colorList.add(new ColorName("Green4", 63, 87, 45));




        colorList.add(new ColorName("Brown",231, 179, 134));
        colorList.add(new ColorName("Brown1",203, 203, 239));
        colorList.add(new ColorName("Brown2",250, 180, 120));
        colorList.add(new ColorName("Brown3",237, 165, 75));
        colorList.add(new ColorName("Brown4",197, 121, 71));


        colorList.add(new ColorName("Blue", 10, 28, 35));
        colorList.add(new ColorName("Blue1", 8, 27, 34));
        colorList.add(new ColorName("Blue2", 24, 53, 68));
        colorList.add(new ColorName("Blue3", 38, 80, 98));
        colorList.add(new ColorName("Blue4", 16, 41, 45));
        colorList.add(new ColorName("Blue5", 17, 38, 41));



        colorList.add(new ColorName("White",237,242,238));
        colorList.add(new ColorName("White1",239,240,234));
        colorList.add(new ColorName("White2",240,245,238));
        colorList.add(new ColorName("White3",184,215,226));
        colorList.add(new ColorName("White3",153,191,230));
        return colorList;
    }
     ...
     */
    private ArrayList<ColorName> initColorList1() {
...
//    }
    ...
    public String getColorNameFromColor(Color color) {
        ...
        return getColorNameFromRgb((int) color.getRed(), (int) color.getGreen(),
                (int) color.getBlue());
    }
